...
def get_food_data(search_term):
    ...
    try:
        ...
        autocomplete_response = safe_requests.get(autocomplete_url, headers=headers, timeout=60)
        ...
        # Request food data
        fooddata_response = safe_requests.get(fooddata_url, headers=headers, timeout=60)
